// v3.0.6.8-40 Comprehensive E2E Test
...
const r1 = await callApi(p, API + '/system/health');
...
const r4 = await callApi(p, API + '/eye/pacs/viewport/init', { method: 'POST', body: { studyId: 'STU001', modality: 'fundus', imageIds: ['f1','f2','f3'] } });
