...
await p.goto('http://127.0.0.1:5199/g005-radiology-ris/eye/toric-planner?t=' + Date.now());
...
const sample = await p.evaluate(() => document.body.innerText.slice(0, 200));
console.log('Sample:', sample);
await p.screenshot({ path: 'verify-pr3.png', fullPage: false });
console.log('📸 verify-pr3.png');
await b.close();
