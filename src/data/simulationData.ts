...
export const INSURANCE_AUDIT_RECORDS: InsuranceAuditRecord[] = [
  {
    ...
    reason: "申请使用碘海醇注射液行胸部CT增强检查",
    submitTime: getRelativeDateStr(5) + " 08:30",
    submitDept: "呼吸内科",
    urgency: "高",
    result: "通过",
    auditor: "医保办-李审核",
    auditTime: getRelativeDateStr(5) + " 09:15",
    auditNotes: "符合医保限定支付条件",
  },
  {
    id: "INS-002",
    patientName: "王芳",
    ...
    submitTime: getRelativeDateStr(5) + " 09:15",
    submitDept: "神经内科",
    urgency: "中",
    result: "通过",
    auditor: "医保办-王审核",
    auditTime: getRelativeDateStr(5) + " 10:00",
    auditNotes: "影像学评估需要",
  },
  {
    id: "INS-003",
    patientName: "李明",
    patientId: "P202600003",
    examType: "CT增强",
    examItem: "腹部CT增强",
    drugName: "碘克沙醇注射液",
    drugCategory: "CT对比剂",
    ...
    submitTime: getRelativeDateStr(4) + " 10:20",
    submitDept: "消化内科",
    urgency: "高",
    result: "通过",
    auditor: "医保办-张审核",
    auditTime: getRelativeDateStr(4) + " 11:00",
    auditNotes: "肝占位评估需要",
  },
  {
    id: "INS-004",
    patientName: "刘洋",
    patientId: "P202600004",
    examType: "MRI增强",
    examItem: "乳腺MRI增强",
    drugName: "钆布醇注射液",
    drugCategory: "MRI对比剂",
    ...
    submitTime: getRelativeDateStr(4) + " 11:45",
    submitDept: "乳腺外科",
    urgency: "中",
    result: "补充资料",
    auditor: "医保办-刘审核",
    auditTime: getRelativeDateStr(4) + " 14:00",
    auditNotes: "需补充病理报告",
  },
  {
    id: "INS-005",
    patientName: "陈静",
    patientId: "P202600005",
    examType: "DSA手术",
    examItem: "冠脉造影",
    drugName: "比伐卢定注射液",
    drugCategory: "抗凝药物",
    ...
    reason: "申请使用比伐卢定注射液行冠脉造影检查",
    submitTime: getRelativeDateStr(4) + " 13:00",
    submitDept: "心内科",
    urgency: "高",
    result: "通过",
    auditor: "医保办-陈审核",
    auditTime: getRelativeDateStr(4) + " 13:30",
    auditNotes: "冠心病诊断明确",
  },
  {
    id: "INS-006",
    patientName: "杨勇",
    patientId: "P202600006",
    examType: "CT增强",
    examItem: "肺动脉CTA",
    drugName: "碘普罗胺注射液",
    drugCategory: "CT对比剂",
    ...
    submitTime: getRelativeDateStr(3) + " 14:30",
    submitDept: "呼吸内科",
    urgency: "高",
    result: "通过",
    auditor: "医保办-李审核",
    auditTime: getRelativeDateStr(3) + " 15:00",
    auditNotes: "疑似肺栓塞，紧急",
  },
  {
    id: "INS-007",
    patientName: "赵磊",
    patientId: "P202600007",
    examType: "MRI增强",
    examItem: "前列腺MRI增强",
    drugName: "钆贝葡胺注射液",
    drugCategory: "MRI对比剂",
    ...
    restriction: "限MRI增强检查使用",
    reason: "申请使用钆贝葡胺注射液行前列腺MRI增强检查",
    submitTime: getRelativeDateStr(3) + " 15:45",
    submitDept: "泌尿外科",
    urgency: "中",
    result: "通过",
    auditor: "医保办-王审核",
    auditTime: getRelativeDateStr(3) + " 16:30",
    auditNotes: "前列腺癌筛查需要",
  },
  {
    id: "INS-008",
    patientName: "黄丽",
    patientId: "P202600008",
    examType: "DSA手术",
    examItem: "脑血管DSA",
    drugName: "肝素钠注射液",
    drugCategory: "抗凝药物",
    drugSpec: "12500U/支",
    restriction: "限DSA手术使用",
    reason: "申请使用肝素钠注射液行脑血管DSA检查",
    submitTime: getRelativeDateStr(2) + " 08:00",
    submitDept: "神经内科",
    urgency: "低",
    result: "拒绝",
    auditor: "医保办-张审核",
    auditTime: getRelativeDateStr(2) + " 09:00",
    auditNotes: "MRA未见明确异常，暂不需要DSA",
  },
  {
    id: "INS-009",
    patientName: "周强",
    patientId: "P202600009",
    examType: "CT增强",
    examItem: "冠脉CTA",
    drugName: "碘佛醇注射液",
    drugCategory: "CT对比剂",
    ...
    submitTime: getRelativeDateStr(2) + " 09:30",
    submitDept: "心内科",
    urgency: "高",
    result: "通过",
    auditor: "医保办-刘审核",
    auditTime: getRelativeDateStr(2) + " 10:15",
    auditNotes: "冠心病筛查需要",
  },
  {
    id: "INS-010",
    patientName: "吴敏",
    patientId: "P202600010",
    examType: "MRI增强",
    examItem: "心脏MR",
    drugName: "钆双胺注射液",
    drugCategory: "MRI对比剂",
    drugSpec: "15ml:4.305g",
    restriction: "限MRI增强检查使用",
    reason: "申请使用钆双胺注射液行心脏MR检查",
    submitTime: getRelativeDateStr(2) + " 10:45",
    submitDept: "心内科",
    urgency: "中",
    result: "通过",
    auditor: "医保办-陈审核",
    auditTime: getRelativeDateStr(2) + " 11:30",
    auditNotes: "心肌病评估需要",
  },
  {
    id: "INS-011",
    patientName: "徐涛",
    patientId: "P202600011",
    examType: "CT增强",
    examItem: "头颅CT增强",
    drugName: "碘帕醇注射液",
    drugCategory: "CT对比剂",
    ...
    submitTime: getRelativeDateStr(1) + " 11:30",
    submitDept: "神经内科",
    urgency: "高",
    result: "通过",
    auditor: "医保办-李审核",
    auditTime: getRelativeDateStr(1) + " 12:00",
    auditNotes: "脑血管病评估",
  },
  {
    id: "INS-012",
    patientName: "孙燕",
    patientId: "P202600012",
    examType: "DSA手术",
    examItem: "肾动脉DSA",
    drugName: "磺达肝癸钠注射液",
    drugCategory: "抗凝药物",
    ...
    submitTime: getRelativeDateStr(1) + " 13:00",
    submitDept: "肾内科",
    urgency: "低",
    result: "补充资料",
    auditor: "医保办-王审核",
    auditTime: getRelativeDateStr(1) + " 14:00",
    auditNotes: "需补充肾功能报告",
  },
  {
    id: "INS-013",
    patientName: "马超",
    patientId: "P202600013",
    examType: "CT增强",
    examItem: "腹部CT增强",
    drugName: "碘海醇注射液",
    drugCategory: "CT对比剂",
    ...
    submitTime: getRelativeDateStr(1) + " 14:15",
    submitDept: "肿瘤科",
    urgency: "中",
    result: "通过",
    auditor: "医保办-张审核",
    auditTime: getRelativeDateStr(1) + " 15:00",
    auditNotes: "肿瘤复查需要",
  },
  {
    id: "INS-014",
    patientName: "朱琳",
    patientId: "P202600014",
    examType: "MRI增强",
    examItem: "颅底MRI增强",
    drugName: "钆特醇注射液",
    drugCategory: "MRI对比剂",
    ...
    restriction: "限MRI增强检查使用",
    reason: "申请使用钆特醇注射液行颅底MRI增强检查",
    submitTime: getRelativeDateStr(0) + " 15:30",
    submitDept: "神经外科",
    urgency: "中",
    result: "通过",
    auditor: "医保办-刘审核",
    auditTime: getRelativeDateStr(0) + " 16:00",
    auditNotes: "颅底病变评估",
  },
  {
    id: "INS-015",
    patientName: "胡鹏",
    patientId: "P202600015",
    examType: "DSA手术",
    examItem: "外周血管DSA",
    drugName: "阿加曲班注射液",
    drugCategory: "抗凝药物",
    ...
    submitTime: getRelativeDateStr(0) + " 16:45",
    submitDept: "血管外科",
    urgency: "低",
    result: "拒绝",
    auditor: "医保办-陈审核",
    auditTime: getRelativeDateStr(0) + " 17:30",
    auditNotes: "抗凝药物选择不符合指南",
  },
];
...
export const FOLLOW_UP_RECORDS: FollowUpRecord[] = [
  {
    id: "FU-001",
    patientId: "P202500001",
    patientName: "李四",
    gender: "男",
    age: 58,
    phone: "138****1111",
    examType: "MRI增强",
    examItemName: "头颅MRI增强",
    examDate: getRelativeDateStr(130),
    followUpType: "肿瘤复查",
    nextFollowUpDate: getRelativeDateStr(-60),
    status: "进行中",
    reaction: "轻度",
    notes: "肺癌术后3个月复查，影像学评估显示稳定",
    referringDoctor: "肿瘤科-张主任",
    department: "肿瘤科",
    createdAt: getRelativeDateStr(130) + " 10:00:00",
  },
  {
    id: "FU-002",
    patientId: "P202500002",
    patientName: "王五",
    gender: "女",
    age: 45,
    phone: "139****2222",
    examType: "CT平扫",
    examItemName: "胸部CT平扫",
    examDate: getRelativeDateStr(30),
    followUpType: "早期肺癌跟踪",
    nextFollowUpDate: getRelativeDateStr(-30),
    status: "已完成",
    reaction: "中度",
    notes: "肺结节6个月随访，大小稳定，继续观察",
    referringDoctor: "呼吸科-李医生",
    department: "呼吸内科",
    createdAt: getRelativeDateStr(30) + " 14:00:00",
  },
  {
    id: "FU-003",
    patientId: "P202500003",
    patientName: "赵六",
    gender: "男",
    age: 62,
    phone: "137****3333",
    examType: "MRI平扫",
    examItemName: "腹部MRI平扫",
    examDate: getRelativeDateStr(60),
    followUpType: "治疗评估",
    nextFollowUpDate: getRelativeDateStr(7),
    status: "逾期",
    reaction: "重度",
    notes: "肝癌介入治疗后影像学评估，肿瘤标记物升高",
    referringDoctor: "消化科-王主任",
    department: "消化内科",
    createdAt: getRelativeDateStr(60) + " 09:00:00",
  },
  {
    id: "FU-004",
    patientId: "P202500004",
    patientName: "钱七",
    gender: "女",
    age: 52,
    phone: "136****4444",
    examType: "PET-CT",
    examItemName: "全身PET-CT",
    examDate: getRelativeDateStr(15),
    followUpType: "术后复查",
    nextFollowUpDate: getRelativeDateStr(-75),
    status: "待随访",
    reaction: "无反应",
    notes: "乳腺癌术后全身评估，未见转移征象",
    referringDoctor: "乳腺科-赵医生",
    department: "乳腺外科",
    createdAt: getRelativeDateStr(15) + " 11:00:00",
  },
  {
    id: "FU-005",
    patientId: "P202500005",
    patientName: "孙八",
    gender: "男",
    age: 68,
    phone: "135****5555",
    examType: "SPECT-CT",
    examItemName: "骨扫描",
    examDate: getRelativeDateStr(25),
    followUpType: "介入治疗后评估",
    nextFollowUpDate: getRelativeDateStr(-190),
    status: "进行中",
    reaction: "轻度",
    notes: "前列腺癌骨转移治疗后疗效评估",
    referringDoctor: "泌尿科-刘主任",
    department: "泌尿外科",
    createdAt: getRelativeDateStr(25) + " 08:30:00",
  },
  {
    id: "FU-006",
    patientId: "P202500006",
    patientName: "周九",
    gender: "女",
    age: 41,
    phone: "134****6666",
    examType: "CT增强",
    examItemName: "腹部CT增强",
    examDate: getRelativeDateStr(120),
    followUpType: "对比剂反应",
    nextFollowUpDate: getRelativeDateStr(-240),
    status: "已完成",
    reaction: "中度",
    notes: "常规增强检查后出现轻微恶心，休息后缓解，已恢复",
    referringDoctor: "体检科-陈医生",
    department: "体检科",
    createdAt: getRelativeDateStr(120) + " 10:30:00",
  },
  {
    id: "FU-007",
    patientId: "P202500007",
    patientName: "吴十",
    gender: "男",
    age: 55,
    phone: "133****7777",
    examType: "MRI增强",
    examItemName: "前列腺MRI增强",
    examDate: getRelativeDateStr(40),
    followUpType: "肿瘤复查",
    nextFollowUpDate: getRelativeDateStr(20),
    status: "逾期",
    reaction: "重度",
    notes: "前列腺癌根治术后生化复发，需进一步评估",
    referringDoctor: "泌尿科-孙主任",
    department: "泌尿外科",
    createdAt: getRelativeDateStr(40) + " 14:00:00",
  },
  {
    id: "FU-008",
    patientId: "P202500008",
    patientName: "郑一",
    gender: "女",
    age: 38,
    phone: "132****8888",
    examType: "CT平扫",
    examItemName: "胸部CT平扫",
    examDate: getRelativeDateStr(125),
    followUpType: "早期肺癌跟踪",
    nextFollowUpDate: getRelativeDateStr(-15),
    status: "待随访",
    reaction: "无反应",
    notes: "肺结节随访中，CT增强后皮疹，给予抗过敏处理后好转",
    referringDoctor: "呼吸科-周医生",
    department: "呼吸内科",
    createdAt: getRelativeDateStr(125) + " 09:00:00",
  },
  {
    id: "FU-009",
    patientId: "P202500009",
    patientName: "冯二",
    gender: "男",
    age: 48,
    phone: "131****9999",
    examType: "MRI平扫",
    examItemName: "腹部MRI平扫",
    examDate: getRelativeDateStr(65),
    followUpType: "治疗评估",
    nextFollowUpDate: getRelativeDateStr(-150),
    status: "进行中",
    reaction: "轻度",
    notes: "肝癌介入治疗后复查，MRI增强后肝功能异常，保肝治疗中",
    referringDoctor: "消化科-吴主任",
    department: "消化内科",
    createdAt: getRelativeDateStr(65) + " 11:30:00",
  },
  {
    id: "FU-010",
    patientId: "P202500010",
    patientName: "陈三",
    gender: "女",
    age: 35,
    phone: "130****0000",
    examType: "PET-CT",
    examItemName: "全身PET-CT",
    examDate: getRelativeDateStr(115),
    followUpType: "术后复查",
    nextFollowUpDate: getRelativeDateStr(-90),
    status: "已完成",
    reaction: "中度",
    notes: "淋巴瘤治疗后评估，注射碘对比剂后出现轻微恶心，休息后缓解",
    referringDoctor: "血液科-杨主任",
    department: "血液科",
    createdAt: getRelativeDateStr(115) + " 08:00:00",
  },
];
...
export const DEVICE_MAINTENANCE_CONTRACTS: DeviceMaintenanceContract[] = [
  {
    id: "MC-001",
    contractNo: "HT-2026-CT-001",
    deviceId: "DEV-CT-01",
    deviceName: "CT-1（GE Revolution CT）",
    deviceModel: "GE Revolution CT",
    serialNumber: "CT2020GE001",
    company: "GE医疗中国",
    contactPerson: "张工",
    contactTel: "400-880-1001",
    startDate: getRelativeDateStr(150),
    endDate: getRelativeDateStr(-15),
    amount: 850000,
    paymentStatus: "已付款",
    coverage: "全保（含CT球管、探测器、软件升级）",
    serviceLevel: "白金",
    renewHistory: [
  ...
  {
    id: "MC-002",
    contractNo: "HT-2026-CT-002",
    deviceId: "DEV-CT-02",
    deviceName: "CT-2（西门子SOMATOM Force）",
    deviceModel: "SOMATOM Force",
    serialNumber: "CT2021SI002",
    company: "西门子医疗",
    contactPerson: "李工",
    contactTel: "400-880-2002",
    startDate: getRelativeDateStr(150),
    endDate: getRelativeDateStr(-15),
    amount: 920000,
    paymentStatus: "已付款",
  ...
  {
    id: "MC-003",
    contractNo: "HT-2026-MR-001",
    deviceId: "DEV-MR-01",
    deviceName: "MR-1（西门子MAGNETOM Vida）",
    deviceModel: "MAGNETOM Vida",
    serialNumber: "MR2020SI001",
    company: "西门子医疗",
    contactPerson: "王工",
    contactTel: "400-880-2003",
    startDate: getRelativeDateStr(150),
    endDate: getRelativeDateStr(-15),
    amount: 1200000,
    paymentStatus: "已付款",
    coverage: "全保（含磁体、梯度放大器、谱仪）",
    serviceLevel: "白金",
    renewHistory: [
  ...
  {
    id: "MC-004",
    contractNo: "HT-2026-MR-002",
    deviceId: "DEV-MR-02",
    deviceName: "MR-2（飞利浦Ingenia）",
    deviceModel: "Ingenia",
    serialNumber: "MR2021PH002",
    company: "飞利浦医疗",
    contactPerson: "赵工",
    contactTel: "400-880-3001",
    startDate: getRelativeDateStr(150),
    endDate: getRelativeDateStr(-15),
    amount: 1150000,
    paymentStatus: "已付款",
  ...
  {
    id: "MC-005",
    contractNo: "HT-2026-DR-001",
    deviceId: "DEV-DR-01",
    deviceName: "DR-1（飞利浦DigitalDiagnost）",
    deviceModel: "DigitalDiagnost",
    serialNumber: "DR2019PH001",
    company: "飞利浦医疗",
    contactPerson: "刘工",
    contactTel: "400-880-3002",
    startDate: getRelativeDateStr(150),
    endDate: getRelativeDateStr(-15),
    amount: 350000,
    paymentStatus: "待付款",
  ...
  {
    id: "MC-006",
    contractNo: "HT-2026-DSA-001",
    deviceId: "DEV-DSA-01",
    deviceName: "DSA-1（飞利浦Azurion 7）",
    deviceModel: "Azurion 7",
    serialNumber: "DSA2020PH001",
    company: "飞利浦医疗",
    contactPerson: "陈工",
    contactTel: "400-880-3003",
    startDate: getRelativeDateStr(150),
    endDate: getRelativeDateStr(-15),
    amount: 1500000,
    paymentStatus: "已付款",
    coverage: "全保（含球管、平板探测器）",
    serviceLevel: "高级",
    renewHistory: [
  ...
  {
    id: "MC-007",
    contractNo: "HT-2026-MG-001",
    deviceId: "DEV-MG-01",
    deviceName: "乳腺钼靶（GE Senographe）",
    deviceModel: "Senographe",
    serialNumber: "MG2019GE001",
    company: "GE医疗中国",
    contactPerson: "周工",
    contactTel: "400-880-1002",
    startDate: getRelativeDateStr(150),
    endDate: getRelativeDateStr(-15),
    amount: 280000,
    paymentStatus: "已付款",
  ...
  {
    id: "MC-008",
    contractNo: "HT-2026-PET-001",
    deviceId: "DEV-PET-01",
    deviceName: "PET-CT（西门子Biograph）",
    deviceModel: "Biograph",
    serialNumber: "PET2020SI001",
    company: "西门子医疗",
    contactPerson: "吴工",
    contactTel: "400-880-2004",
    startDate: getRelativeDateStr(150),
    endDate: getRelativeDateStr(-15),
    amount: 2800000,
    paymentStatus: "已付款",
    coverage: "全保（含晶体、探测器、软件）",
    serviceLevel: "白金",
    renewHistory: [
  ...
  {
    id: "MC-009",
    contractNo: "HT-2026-SPECT-001",
    deviceId: "DEV-SPECT-01",
    deviceName: "SPECT-CT（GE Discovery）",
    deviceModel: "Discovery",
    serialNumber: "SPECT2019GE001",
    company: "GE医疗中国",
    contactPerson: "郑工",
    contactTel: "400-880-1003",
    startDate: getRelativeDateStr(150),
    endDate: getRelativeDateStr(-15),
    amount: 680000,
    paymentStatus: "已付款",
  ...
  {
    id: "MC-010",
    contractNo: "HT-2026-CT-003",
    deviceId: "DEV-CT-03",
    deviceName: "CT-3（飞利浦Access CT）",
    deviceModel: "Access CT",
    serialNumber: "CT2018PH003",
    company: "飞利浦医疗",
    contactPerson: "冯工",
    contactTel: "400-880-3004",
    startDate: getRelativeDateStr(150),
    endDate: getRelativeDateStr(-15),
    amount: 420000,
    paymentStatus: "已逾期",
    coverage: "标准保养",
    serviceLevel: "标准",
    renewHistory: [{ year: 2025, amount: 400000, status: "已到期" }],
    createdAt: getRelativeDateStr(180) + " 10:00:00",
  },
];
...
export const CLINICAL_SYNC_RECORDS: ClinicalSyncRecord[] = [
  {
    ...
    patientName: "张伟",
    dataContent: "门诊挂号信息",
    syncTime: getRelativeDateStr(1) + " 08:00:00",
    status: "已同步",
    retryCount: 0,
    dataVolume: "2KB",
    sourceDept: "挂号处",
  },
  {
    ...
    patientId: "P202600002",
    patientName: "王芳",
    dataContent: "MRI头颅检查图像",
    syncTime: getRelativeDateStr(1) + " 09:30:00",
    status: "已同步",
    retryCount: 0,
    dataVolume: "120MB",
    sourceDept: "放射科",
  },
  {
    ...
    patientName: "李明",
    dataContent: "肝功能检验结果",
    syncTime: getRelativeDateStr(1) + " 10:15:00",
    status: "已同步",
    retryCount: 0,
    dataVolume: "15KB",
    sourceDept: "检验科",
  },
  {
    ...
    patientId: "P202600004",
    patientName: "刘洋",
    dataContent: "乳腺MRI增强医嘱",
    syncTime: getRelativeDateStr(0) + " 11:00:00",
    status: "同步中",
    retryCount: 1,
    dataVolume: "3KB",
    sourceDept: "乳腺外科",
  },
  {
    ...
    patientId: "P202600005",
    patientName: "陈静",
    dataContent: "DR腰椎正侧位图像",
    syncTime: getRelativeDateStr(0) + " 11:30:00",
    status: "已同步",
    retryCount: 0,
    dataVolume: "8MB",
    sourceDept: "放射科",
...
export const CONSULTATION_RECORDS: ConsultationRecord[] = [
  {
    ...
    targetDoctor: "影像科-张教授",
    consultationType: "MDT",
    urgency: "紧急",
    status: "已完成",
    requestTime: getRelativeDateStr(5) + " 14:00:00",
    completedTime: getRelativeDateStr(3) + " 10:00:00",
    diagnosis: "肝占位性病变，倾向于肝血管瘤可能",
    opinion: "建议行MRI增强进一步明确性质",
  },
  {
    id: "CONS-002",
    consultationNo: "远程-2026-015",
    patientName: "刘洋",
    patientId: "P202600004",
    gender: "女",
    age: 28,
    ...
    requestDept: "乳腺外科",
    requestDoctor: "周婷",
    targetHospital: "复旦大学肿瘤医院",
    targetDoctor: "乳腺科-王教授",
    consultationType: "远程会诊",
    urgency: "普通",
    status: "已回复",
  ...
  },
  {
    ...
    requestDept: "神经外科",
    requestDoctor: "肖强",
    targetHospital: "上海华山医院",
    targetDoctor: "神经介入科-李教授",
