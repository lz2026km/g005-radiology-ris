    ...
    >
      ...
      {converted.length > 0 && (
        <div style={{ background: '#ecfdf5', border: '1px solid #a7f3d0', borderRadius: 6, padding: 8 }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 4, fontSize: 11, fontWeight: 700, color: '#065f46' }}>
            <Check size={12} /> 已转换 {converted.length} 项测量
          </div>
          <ul style={{ margin: '6px 0 0', padding: '0 0 0 16px', fontSize: 11, color: '#065f46' }}>
