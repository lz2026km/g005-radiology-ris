...
import { SHORTCUTS, SHORTCUT_LIST, SHORTCUT_GROUPS, formatShortcut, type ShortcutDef } from '../../config/shortcuts'
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <span>
            <kbd style={kbdStyle}>↑</kbd> <kbd style={kbdStyle}>↓</kbd> {isZh ? '导航' : 'Navigate'}
          </span>
          <span>
