...
import {
  ...
  Calendar, // 统计图表相关图标
  BarChart3, // 新增图标
  GripVertical, Activity, AlertCircle,
  AlertTriangle, ArrowRight, Award, BarChart3, BarChart4, Building2, Check, CheckCircle,
  CheckSquare, ChevronRight, Circle, Clock, Copy, Database, Download, Edit3,
  Eye, FileSpreadsheet, FileText, Filter, FolderTree, Gauge, GitBranch, Globe,
  Image, Layers, LayoutDashboard, Maximize2, MessageSquare, Minimize2, Monitor, MoreVertical,
  MousePointer, Move, Network, PanelRight, Percent, PieChart, Plus, Radio,
  RefreshCw, Repeat, Save, Scan, Search, Send, Server, Settings,
  Share2, ShieldCheck, Sigma, Sliders, Table2, Target, Timer, Trash2,
  TrendingDown, TrendingUp, User, Users, Video, Wrench, X, Zap,
} from "lucide-react";
import {
  BarChart,
  Bar,
