...
export const SIDEBAR_ITEMS: ReadonlyArray<SidebarSection> = [
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        icon: React.createElement(UserCircle, { size: 18 }),
  ...
  },
  {
    ...
    items: [
      {
        path: "/write-report",
        icon: React.createElement(Edit3, { size: 18 }),
      ...
      {
        path: "/report-review",
        icon: React.createElement(ClipboardCheck, { size: 18 }),
      ...
      {
        path: "/publish",
        icon: React.createElement(FileStack, { size: 18 }),
      ...
      {
        path: "/ca-signature",
        icon: React.createElement(Stamp, { size: 18 }),
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        icon: React.createElement(ShieldAlert, { size: 18 }),
  ...
  },
  {
    ...
    items: [
      ...
      {
        path: "/typical-cases",
        icon: React.createElement(GraduationCap, { size: 18 }),
      ...
      },
      {
        ...
        icon: React.createElement(Radio, { size: 18 }),
  ...
  },
  {
    ...
    items: [
      ...
      {
        path: "/department",
        icon: React.createElement(UsersRound, { size: 18 }),
  ...
  },
  {
    ...
    items: [
      ...
      {
        path: "/device-fault",
        icon: React.createElement(Wrench, { size: 18 }),
