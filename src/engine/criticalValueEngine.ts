...
export interface CriticalRule {
  ...
  notification: { phone: boolean; sms: boolean; system: boolean; email: boolean; wechat: boolean; dingtalk: boolean };
  ackRequired: boolean;
...
export const CRITICAL_VALUE_RULES: CriticalRule[] = [
  ...
  { id: 'cv-neuro-001', name: '脑出血', category: 'neuro', modality: ['CT', 'MR'], bodyPart: ['头颅'],
    ...
    severity: 'critical', notification: { phone: true, sms: true, system: true, email: true, wechat: false, dingtalk: true }, ackRequired: true, ackTimeout: 15 },
  { id: 'cv-neuro-002', name: '急性脑梗死', category: 'neuro', modality: ['CT', 'MR'], bodyPart: ['头颅'],
    keywords: ['急性脑梗死', '脑梗死', '脑栓塞'],
    patterns: [/急性脑梗死/i, /急性大面积脑梗死/i],
    severity: 'critical', notification: { phone: false, sms: true, system: true, email: false, wechat: true, dingtalk: false }, ackRequired: true, ackTimeout: 30 },
  { id: 'cv-neuro-003', name: '动脉瘤', category: 'neuro', modality: ['CT', 'MR', 'DSA'], bodyPart: ['头颅', '胸部'],
    keywords: ['动脉瘤', '动脉瘤破裂'],
    patterns: [/动脉瘤.*?(破裂|出血)/i],
    severity: 'critical', notification: { phone: true, sms: true, system: true, email: true, wechat: true, dingtalk: true }, ackRequired: true, ackTimeout: 15 },
  ...
  { id: 'cv-cardio-001', name: '主动脉夹层', category: 'vascular', modality: ['CT', 'MR'], bodyPart: ['胸部', '腹部'],
    ...
    severity: 'critical', notification: { phone: true, sms: true, system: true, email: true, wechat: true, dingtalk: true }, ackRequired: true, ackTimeout: 10 },
  { id: 'cv-cardio-002', name: '肺栓塞', category: 'pulmo', modality: ['CT'], bodyPart: ['胸部'],
    ...
    severity: 'critical', notification: { phone: true, sms: true, system: true, email: false, wechat: true, dingtalk: true }, ackRequired: true, ackTimeout: 30 },
  ...
  { id: 'cv-abd-001', name: '消化道穿孔', category: 'abdomen', modality: ['CT', 'DR'], bodyPart: ['腹部'],
    ...
    severity: 'critical', notification: { phone: true, sms: true, system: true, email: false, wechat: true, dingtalk: true }, ackRequired: true, ackTimeout: 10 },
  ...
  { id: 'cv-trauma-001', name: '骨折伴脱位', category: 'trauma', modality: ['CT', 'DR'], bodyPart: ['四肢', '脊柱'],
    ...
    severity: 'urgent', notification: { phone: false, sms: false, system: true, email: false, wechat: false, dingtalk: false }, ackRequired: false, ackTimeout: 0 },
];
